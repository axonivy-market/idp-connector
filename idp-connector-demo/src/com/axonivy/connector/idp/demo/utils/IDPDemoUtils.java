...
public class IDPDemoUtils {
	...
	public static List<SubDocument> toSubDocumentList(JsonNode json) throws JsonProcessingException, IllegalArgumentException {
		...
		GenericSplittingProcessingCompleted processingCompleted = mapper.treeToValue(json, GenericSplittingProcessingCompleted.class);
	...
	public static List<SubDocument> toSubDocumentList(GenericSplittingProcessingCompleted result) {
		if (result == null || result.getDocumentSplitting() == null || CollectionUtils.isEmpty(result.getDocumentSplitting().getSubDocuments())) {
			return null;
		}
	...
	public static List<Extraction> toExactionList(JsonNode jsonNode) throws JsonProcessingException, IllegalArgumentException {
		...
		Iterator<Entry<String, JsonNode>> fieldsIterator = extractionNode.fields(); 
	 ...
	 */
	public static List<String> extractLineItemHeader(JsonNode jsonNode, boolean onlyNoNull) throws JsonProcessingException, IllegalArgumentException {
